<?php
/**
 * The template part for displaying archive-news
 *
 * @package WordPress
						...
						<div class="archive">
							<?php if ( have_posts() ) : ?>
								...
								while ( have_posts() ) : the_post();
									 ...
									 */
									get_template_part( 'template-parts/research/content', get_post_format() );
							...
							// If no content, include the "No posts found" template.
								...
								get_template_part( 'template-parts/research/content', 'none' );
