							...
							<div class="<?php echo esc_attr( visualcomposerstarter_get_maincontent_block_class() ); ?>">
								<div class="col-md-2">
									...
									//Disable Author Picture
										//get_template_part( 'template-parts/research/biography' );
									?>
								</div><!--.col-md-2-->
								<div class="col-md-10">
									<?php
									
									get_template_part( 'template-parts/research/content', 'single' );;?>
									 ...
									 * Add category link
									 */
									echo 'หมวดหมู่: '; customtype_get_terms( $post->ID, 'research-type' ); echo '<br />';
									/*
									 * Add tags link
									 */
									echo 'ป้าย: '; customtype_get_terms( $post->ID, 'research-tag' );
